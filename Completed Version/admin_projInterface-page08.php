    ...
    <div class="w3-row">
        ...
        <div class="w3-rest w3-container" style="background-color: azure;">
            ...
            <div>
                ...
                <a href="/public_html/CreateProjectAdmin-page12.php"
            ...
            <div>
                <table class="w3-table w3-bordered">
                    ...
                    <!-- Here we link database to table of students -->
                        ...
                        $selectquery = "SELECT * FROM student, project WHERE project.username = student.username";
                        // $selectquery = "SELECT * FROM project, student";

                        $query = mysqli_query($conn, $selectquery);

                        while ($res = mysqli_fetch_array($query)) {
                            $proj_name = $res['proj_name'];
                            // $sumSQL2 = "SELECT count(*) AS taskcompleted FROM `task` WHERE proj_name = '$proj_name' AND state == 4;
                        ...
                        echo "
                            <tr>
                                ...
                                <td>".$row_count1."</td>
                                <td>
                                    <!-- taking proj_name as a variable for new task page -->
                                    <a href='/public_html/task_Interface-page-05.php?proj_name=".$res['proj_name']."' class='w3-green w3-button w3-padding-small'>Open</a>

                                    <form action='/public_html/deleteproj.php?proj_name=".$res['proj_name']."' method='post'>
                                        <button class='w3-red w3-button w3-padding-small' name='delete'>Delete</button>
                                    </form>
                                </td>
                                    </tr>";
