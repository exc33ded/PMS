...
<br>
    <a class="w3-button w3-amber w3-ripple w3-round-xxlarge w3-right" href="task_Interface-page-05.php?proj_name=<?php echo $proj_name ?>">Back</a><br>
    <br>
    <div class="w3-margin w3-topbar w3-bottombar w3-rightbar w3-leftbar w3-padding">
<div class="container task-view w3-center">
    <h1 class='w3-text-blue-grey'><u><?php echo $proj_name . '-' . $task_num ?></u></h1>
    ...
    <div class="w3-bar w3-border w3-light-grey w3-padding" style="margin-top: 48vh;">
