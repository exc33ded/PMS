<?php
  ...
  if (!(isset($_GET['proj_name']))) {
    header('Location: task_Interface(user)-page-05.php');
    exit();
}
    ...
    <div class="w3-container w3-border w3-margin w3-topbar w3-bottombar w3-rightbar w3-leftbar w3-padding">
        <form action="" method="post">
            <div>
                ...
                <input type="text" placeholder="enter task name" name="task_name" class="w3-input w3-hover-border-amber">
            </div>
            ...
            <div>
                ...
                <br><textarea name="task_desc" cols="30" rows="10" class="textarea"></textarea>
            </div>
            ...
            <span>
                ...
                <div>
                    <a href="/public_html/task_Interface(user)-page-05.php" class="w3-button w3-amber w3-hover-blue-gray w3-right">GO BACK</a>
